...
export default function RinkEventsTab() {
  const { data: events, reload } = useApi('/rink-events');
  ...
  return (
    <div>
      ...
      <p className={styles.hint}>
        Events pulled from Rink Events calendars configured in the Calendars tab.
      </p>

      {weekNav}

      {dayOrder.length === 0 && (
        <p className={styles.muted}>No rink events this week.</p>
      )}
